...
import { ojMenu } from "@oracle/oraclejet/dist/types/ojmenu";
...
class RootViewModel {
  ...
  afficheHeader: ko.Observable<boolean>;
  userData: ko.Observable<object>;

  constructor() {
    this.afficheHeader = ko.observable(false);
  ...
  logout = (): void => {
    fetch('https://jde925.inetum.group:20221/jderest/v3/orchestrator/jde-logout', {
            method: 'POST',
            headers: {
  ...
  menuItemAction = (event: ojMenu.ojMenuAction) => {
